...
<div class="container">
    ...
    <h1 class="terms-and-condition" style="margin-top: 20px; margin-left: 65px;"><img src="/assets/images/Group 349.png" alt="Call Icon" style="margin-right:10px;">Privacy Policy</h1>
        ...
        <p class="we-are-a" style="text-align: justify; margin-bottom: 10px; margin-left: 190px; margin-right: 170px; font-size: 20px;"><b>Web Beacons, Tags, and Pixels</b></p>
        <p class="we-are-a" style="text-align: justify; margin-bottom: 40px; margin-left: 190px; margin-right: 170px; font-size: 20px;">We may use web beacons, tags, and pixels to track user behavior, understand website traffic, and measure the effectiveness of our marketing efforts. This information is used solely for analytics and improving user experience.</p>
